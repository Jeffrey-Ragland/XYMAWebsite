      ...
      <article>
        ...
        <div className="text-[#60646C] text-xs md:text-base xl:text-lg 2xl:text-2xl mx-[3%] mb-4 text-justify">
          <p className="mb-4">
            ...
            temperature fluctuations. The aluminum smelting process involves
            high temperatures and the handling of molten metal, which presents
            significant hazards. By closely monitoring the temperature of the
            pot shell, operators can detect any abnormalities or potential
            issues before they escalate into safety hazards such as overheating
        ...
        <div className=" mx-2 mb-6">
          <div>
            ...
            >
              <li>
                The extreme temperatures involved in the smelting process can
                make it difficult to accurately measure and maintain consistent
                readings. The high heat can lead to sensor malfunction or
                damage, impacting the reliability of temperature data.
              </li>
              <li>
                The harsh operating conditions, such as dust, vibrations, and
                chemical exposure, further exacerbate these challenges by
                potentially interfering with monitoring equipment and reducing
                its lifespan.
              </li>
              <li>
                Moreover, the size and scale of aluminum manufacturing
                facilities often mean that numerous pot shells need to be
                monitored simultaneously, complicating the task of ensuring
                comprehensive and real-time temperature monitoring across the
                entire operation. This can lead to delays in detecting
                temperature fluctuations or hotspots, which could potentially
                result in equipment damage or safety hazards if not addressed
                promptly.
              </li>
              <li>
        ...
        <h3 className="font-medium text-base md:text-lg lg:text-xl 2xl:text-2xl mb-4">
