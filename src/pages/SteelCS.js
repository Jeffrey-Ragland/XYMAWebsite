      ...
      <article>
        ...
        <div className="text-[#60646C] text-xs md:text-base xl:text-lg 2xl:text-2xl mx-[3%] mb-4 text-justify">
          <p className="mb-4">
            ...
            tundish preheating process. Improvements in the preheating process
            can significantly save enormous amount of energy.
          </p>

          <p>
            Temperature Monitoring is also important to achieve consistent
            product quality and high productivity. Various operating faults and
            quality defects can be avoided by continuous temperature monitoring.
            So, continuous temperature monitoring of tundish enables the use of
        ...
        <div className="mx-2 mb-6">
          ...
          <figure className="flex justify-center mb-6 mt-6">
            <img
              src={csImg1}
              alt="steelPlant"
          ...
          >
            <li>
              Superheat in the casting process refers to the temperature
              increase of the molten metal above its melting point. Accurate
              measurement of this elevated temperature is required to reliably
              control the casting speed of the machine.
            </li>
            <li>
              ...
              superheat is too high, an increased risk of various defects such
              as lower-quality microstructure and breakouts can ensue. A high
              superheat also increases energy losses, necessitating more
              cooling. Predictive models for fluid dynamics and tundish heat
              losses can be used to assess and improve superheat control and
              refractory wear.
            </li>
          </ul>
        </div>
        ...
        <div className=" mx-2 mb-6">
          <div>
            ...
            >
              <li>
                Pre-heating tundish helps maintain the desired temperature of
                the molten metal as it passes through the tundish, ensuring
                consistent casting conditions and preventing premature
                solidification. Secondly, preheating reduces the risk of thermal
                shock to the refractory lining of the tundish, which could
                otherwise lead to cracking or failure.
              </li>
              <li>
                ...
                typically within hours or a few days. They have short lifespan
                due to the harsh conditions they endure during the casting
                process.
              </li>
              <li>
                An accurate, information-rich, fast, minimally invasive and
                multi point temperature measurement system is highly desirable
                to measure continuous temperature measurements of tundish.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className=" mx-2 mb-6">
          <div>
            ...
            >
              <li>
                XYMA's Multi-point temperature Sensor is capable of measuring
                high temperatures at multiple points in real-time across any
              ...
              <li>
                ...
                from the received ultrasonic signals.
              </li>
              <li>
                The output from the edge classifiers is transmitted to the
                dashboard using industrial standard, wireless (or wired)
                communication technology using a transmitting unit. The status
                can be monitored in the client DCS system and also can be
                displayed in XYMA's customizable dashboard.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className=" mx-2 mb-6">
          <div>
            ...
            >
              <li>
                μTMapS Multi Point Temperature Mapping Sensors helps to reduce
                the complex pre-heating procedure of tundish. These sensors
                utilize ultrasonic technology to accurately measure and monitor
              ...
              <li>
                The control of superheat can be managed efficiently, With
                accurate temperature data, operators can optimize the heating
                system to ensure that the entire tundish reaches the desired
                temperature efficiently. By targeting specific areas that may
                require more heating and minimizing over-heating in other areas,
                the pre-heating process can be streamlined, saving time and
                energy.
              </li>
              <li>
              ...
              <li>
                Overall, the integration of μTMapS Multi Point Temperature
                Mapping Sensors streamlines the pre-heating process for
                tundishes, resulting in cost savings, improved efficiency, and
                enhanced product quality in steel Industry.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className=" mx-2 mb-6">
          <div>
            ...
            >
              <li>
                The optimal solution is to invest in long life time sensors
                which measure continuous spatial temperature of tundish. μTMapS
                Multi Point Temperature Mapping Sensors would be robust product
                to measure accurate spatial temperature of tundish.
              </li>
              <li>
                The system works with novelized technology and best industrial
                standards to detect the real time multi point and multi
                parameter measurement in a cost efficient way. By
                revolutionizing the pre-heating procedure with ultrasonic
                waveguide sensors, The Steel Industry majorly saves large energy
                cost and unlock their high potential in production.
              </li>
            </ul>
          </div>
        </div>
