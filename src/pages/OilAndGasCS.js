    ...
    <div className=" mx-[5%] overflow-hidden">
      ...
      <article>
        ...
        <div className="text-[#60646C] text-xs md:text-base xl:text-lg 2xl:text-2xl mx-[3%] mb-4 text-justify">
          <p className="mb-4">
            Temperature monitoring in reformer tubes is paramount for the safe
            and smooth operation in refineries. High temperatures can lead to
            thermal stresses and material degradation in reformer tubes.
            Monitoring temperatures helps to assess the condition of the tubes
            and detect any signs of deterioration or damage, allowing for timely
            maintenance or replacement to avoid unplanned downtime and costly
            repairs.
          </p>
        </div>
        ...
        <div className="mx-2 mb-6">
          ...
          >
            <li>
              ...
              high temperatures and pressures, can make it difficult to
              accurately measure and maintain temperatures within the tubes.
            </li>
            <li>
              The high temperatures, pressures, and corrosive environments
              within refineries can accelerate oil degradation and make accurate
        ...
        <div className="mx-2 mb-6">
          ...
          >
            ...
            <li>
              ...
              of the reformer tube and dashboard gives timely alerts to safely
        ...
        <h1 className="font-semibold text-lg md:text-2xl lg:text-3xl 2xl:text-5xl mx-[3%]">
        ...
        <div className="text-[#60646C] text-xs md:text-base xl:text-lg 2xl:text-2xl mx-[3%] mb-4 text-justify">
          <p className="mb-4">
            ...
            monitoring oil properties enables early detection of potential
            issues within machinery . It also allows for timely oil changes or
        ...
        <div className="mx-2 mb-6">
          ...
          >
            <li>
              Oil monitoring is challenging due to its complex process.
              Monitoring involves tracking parameters such as temperature,
              pressure, flow rates, and chemical composition throughout process
              stages which can require specialized equipment and expertise.
            </li>
          </ul>
          ...
          >
            <li>
              Obtaining representative oil samples for analysis can be
              difficult, especially in large or inaccessible machinery. Improper
              sampling techniques can lead to inaccurate results.
            </li>
            <li>
              Interpreting oil monitoring data and translating it into
              actionable insights that imply equipment health and performance is
              difficult.
            </li>
          </ul>
        </div>
        ...
        <div className="mx-2 mb-6">
          ...
          >
            <li>
              ...
              sensor to continuously monitor viscosity, density and temperature
              of a fluid with high reliability and precision using single
          ...
          >
            ...
            <li>
              The AI- Powered soft sensors can provide 3D temperature profiles
              of any asset. The dashboard gives timely alerts to safely maintain
