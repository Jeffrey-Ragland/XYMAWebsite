  ...
  return (
    <div className=" mx-[5%] overflow-hidden">
      ...
      <div className="text-[#60646C] text-xs md:text-base xl:text-lg 2xl:text-2xl mx-[3%] mb-4 text-justify">
        <div className="mb-4">
          The case study explains how the paint industry overcome the problem of
          monitoring the continuous viscosity of the paint, which directly
          affects its quality. The paint mixture homogeneity monitoring involves
          ensuring consistency and uniformity in paint formulations throughout
          the manufacturing process.By closely monitoring the composition,
          color, viscosity, and other key parameters of the paint mixture
          throughout the manufacturing process, the manufacturers can guarantee
          that each batch meets the desired quality standards.
        </div>
        ...
        <div>
          ...
          customer satisfaction in the paint manufacturing industry.Consistency
          in paint formulations is essential for maintaining the brand
          reputation and meeting customer expectations.
        </div>
      </div>
